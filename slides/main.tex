...
\end{frame}
%----------------------------------------------------------------------------------------------------------
\begin{frame}{Разбиение временного ряда для обучения}

\begin{figure}[h]
  \begin{minipage}{0.7\textwidth}
    \includegraphics[width=\linewidth]{experiment_setting.png}
  
  \end{minipage}\hfill
  \caption*{\centering
Схема разделения временного ряда для обучения модели:
  \begin{itemize}
      \item[-] history ts -- используется для обучения $f, g$,
      \item[-] F train -- используется для обучения $F$,
      \item[-] F test -- оценка качества F
  \end{itemize} }
\end{figure}
